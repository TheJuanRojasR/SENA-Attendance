...
export const AuditLogDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      <ModalHeader data-cy="auditLogDeleteDialogHeading" closeButton>
        <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
      </ModalHeader>
      <ModalBody id="senaAttendanceApp.auditLog.delete.question">
        <Translate contentKey="senaAttendanceApp.auditLog.delete.question" interpolate={{ id: auditLogEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="project-confirm-delete-auditLog" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
