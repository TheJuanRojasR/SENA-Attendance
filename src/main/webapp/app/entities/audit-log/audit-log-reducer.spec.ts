...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './audit-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_AUDITLOG actions', async () => {
      const arg = { id: '3cd293e7-61a9-4351-9411-9576d8593849' };
