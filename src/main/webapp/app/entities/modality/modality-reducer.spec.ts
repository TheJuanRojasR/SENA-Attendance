...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './modality.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODALITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MODALITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MODALITY actions', async () => {
      const arg = { id: '9fbb3b28-8dca-4aca-839a-b7d13b7197dc' };
    ...
    it('dispatches UPDATE_MODALITY actions', async () => {
      const arg = { id: '9fbb3b28-8dca-4aca-839a-b7d13b7197dc' };
    ...
    it('dispatches PARTIAL_UPDATE_MODALITY actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MODALITY actions', async () => {
      const arg = 42666;
