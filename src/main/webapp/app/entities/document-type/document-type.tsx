      ...
      <h2 id="document-type-heading" data-cy="DocumentTypeHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="senaAttendanceApp.documentType.home.refreshListLabel">Refresh List</Translate>
          </Button>
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="senaAttendanceApp.documentType.id">ID</Translate>{' '}
            ...
            <tbody>
              {documentTypeList.map(documentType => (
                <tr key={`entity-${documentType.id}`} data-cy="entityTable">
                  <td>
                    <Button as={Link as any} to={`/document-type/${documentType.id}`} variant="link" size="sm">
                      {documentType.id}
                    </Button>
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button
                        as={Link as any}
                        to={`/document-type/${documentType.id}`}
                        variant="info"
                        size="sm"
