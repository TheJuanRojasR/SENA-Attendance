...
import { ITrimester, defaultValue } from 'app/shared/model/trimester.model';
import { EntityState } from 'app/shared/reducers/reducer.utils';

import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './trimester.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ITrimester> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIMESTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRIMESTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRIMESTER actions', async () => {
      const arg = { id: 'fc8f5153-f1b8-4ede-b817-9b6c218e886f' };
    ...
    it('dispatches UPDATE_TRIMESTER actions', async () => {
      const arg = { id: 'fc8f5153-f1b8-4ede-b817-9b6c218e886f' };
    ...
    it('dispatches PARTIAL_UPDATE_TRIMESTER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TRIMESTER actions', async () => {
      const arg = 42666;
