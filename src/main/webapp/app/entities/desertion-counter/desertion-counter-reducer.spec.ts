...
import reducer, {
  ...
  reset,
  updateEntity,
} from './desertion-counter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESERTIONCOUNTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DESERTIONCOUNTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DESERTIONCOUNTER actions', async () => {
      const arg = { id: '16b3c042-7bba-43bf-8706-a980cc47fb7a' };
    ...
    it('dispatches UPDATE_DESERTIONCOUNTER actions', async () => {
      const arg = { id: '16b3c042-7bba-43bf-8706-a980cc47fb7a' };
    ...
    it('dispatches PARTIAL_UPDATE_DESERTIONCOUNTER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_DESERTIONCOUNTER actions', async () => {
      const arg = 42666;
