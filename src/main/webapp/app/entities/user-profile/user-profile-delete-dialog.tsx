...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="senaAttendanceApp.userProfile.delete.question">
        <Translate contentKey="senaAttendanceApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="project-confirm-delete-userProfile" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
