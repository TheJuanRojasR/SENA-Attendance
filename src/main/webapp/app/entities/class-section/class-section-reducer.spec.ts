...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSSECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSSECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSSECTION actions', async () => {
      const arg = { id: '43d1df1c-9f28-4129-b32f-58edbcc5b966' };
    ...
    it('dispatches UPDATE_CLASSSECTION actions', async () => {
      const arg = { id: '43d1df1c-9f28-4129-b32f-58edbcc5b966' };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSSECTION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CLASSSECTION actions', async () => {
      const arg = 42666;
