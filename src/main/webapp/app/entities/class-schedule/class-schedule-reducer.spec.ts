...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSSCHEDULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSSCHEDULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSSCHEDULE actions', async () => {
      const arg = { id: '720fb6fc-3aa8-4c88-8cdc-4bed5d34e880' };
    ...
    it('dispatches UPDATE_CLASSSCHEDULE actions', async () => {
      const arg = { id: '720fb6fc-3aa8-4c88-8cdc-4bed5d34e880' };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSSCHEDULE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CLASSSCHEDULE actions', async () => {
      const arg = 42666;
