...
import { IJustificationType, defaultValue } from 'app/shared/model/justification-type.model';
...
import reducer, {
  ...
  reset,
  updateEntity,
} from './justification-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IJustificationType> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JUSTIFICATIONTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JUSTIFICATIONTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JUSTIFICATIONTYPE actions', async () => {
      const arg = { id: '4a2442c3-bada-4fe5-b7f9-ff7a97d09068' };
    ...
    it('dispatches UPDATE_JUSTIFICATIONTYPE actions', async () => {
      const arg = { id: '4a2442c3-bada-4fe5-b7f9-ff7a97d09068' };
    ...
    it('dispatches PARTIAL_UPDATE_JUSTIFICATIONTYPE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_JUSTIFICATIONTYPE actions', async () => {
      const arg = 42666;
