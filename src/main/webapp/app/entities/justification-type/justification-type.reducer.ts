...
const apiUrl = 'api/justification-types';

// Actions

export const getEntities = createAsyncThunk(
  'justificationType/fetch_entity_list',
...
export const createEntity = createAsyncThunk(
  'justificationType/create_entity',
  async (entity: IJustificationType, thunkAPI) => {
    const result = await axios.post<IJustificationType>(apiUrl, cleanEntity(entity));
...
export const deleteEntity = createAsyncThunk(
  'justificationType/delete_entity',
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IJustificationType>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const JustificationTypeSlice = createEntitySlice({
...
export const { reset } = JustificationTypeSlice.actions;
