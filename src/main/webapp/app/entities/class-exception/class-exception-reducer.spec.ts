...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSEXCEPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSEXCEPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSEXCEPTION actions', async () => {
      const arg = { id: 'fe19697c-437f-43db-b346-bb5a02c679ab' };
    ...
    it('dispatches UPDATE_CLASSEXCEPTION actions', async () => {
      const arg = { id: 'fe19697c-437f-43db-b346-bb5a02c679ab' };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSEXCEPTION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CLASSEXCEPTION actions', async () => {
      const arg = 42666;
