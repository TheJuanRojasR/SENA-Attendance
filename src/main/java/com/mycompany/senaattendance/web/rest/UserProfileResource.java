...
/**
 * REST controller for managing {@link com.mycompany.senaattendance.domain.UserProfile}.
 */
@RestController
...
public class UserProfileResource {
    ...
    public ResponseEntity<UserProfileDTO> createUserProfile(@Valid @RequestBody UserProfileDTO userProfileDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/user-profiles/" + userProfileDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, userProfileDTO.getId()))
            .body(userProfileDTO);
    }
