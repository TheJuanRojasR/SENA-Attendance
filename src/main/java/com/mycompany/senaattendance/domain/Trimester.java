...
public class Trimester extends AbstractAuditingEntity implements Serializable {
    ...
    public Trimester name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public Trimester startDate(LocalDate startDate) {
    ...
    public Trimester endDate(LocalDate endDate) {
    ...
    public Trimester status(StateTrimester status) {
