...
import static com.mycompany.senaattendance.domain.UserProfileAsserts.*;
...
class UserProfileResourceIT {
    ...
    public static UserProfile createUpdatedEntity() {
        ...
        documentType.setId("fixed-id-for-tests");
        updatedUserProfile.setDocumentType(documentType);
    ...
    void checkFirstLastNameIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        userProfile.setFirstLastName(null);
    ...
    void checkDocumentNumberIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        userProfile.setDocumentNumber(null);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.firstName(UPDATED_FIRST_NAME).middleName(UPDATED_MIDDLE_NAME).documentNumber(UPDATED_DOCUMENT_NUMBER);
