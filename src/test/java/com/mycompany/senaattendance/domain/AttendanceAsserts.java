...
public class AttendanceAsserts {
    ...
    public static void assertAttendanceUpdatableFieldsEquals(Attendance expected, Attendance actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getStateAttendance()).as("check stateAttendance").isEqualTo(expected.getStateAttendance()));
    }
    ...
    public static void assertAttendanceUpdatableRelationshipsEquals(Attendance expected, Attendance actual) {
        assertThat(actual)
            ...
            .satisfies(a ->
                assertThat(a.getModifiedByJustification())
                    .as("check modifiedByJustification")
                    .isEqualTo(expected.getModifiedByJustification())
            );
    }
}
