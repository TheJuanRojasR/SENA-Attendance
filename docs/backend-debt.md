...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `@PreAuthorize` con `ROLE_COORDINATOR`              | Varios resources siguen aceptando un rol que los casos de uso ya no contemplan; debe quedar solo `ROLE_ADMIN` (u operativo donde aplique). | `web/rest/DocumentTypeResource.java:55`; `ModalityResource.java:55`; `ProgramResource.java:63`; `TrimesterResource.java:61` | `Pendiente` |
