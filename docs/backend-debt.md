...
| UC019 — Configuración global         | Los cuatro parámetros del UC ya están en el modelo, incluidos los umbrales de alerta de UC013; quedan las unidades posteriores de semántica singleton, permisos y validación.                                                                   | `domain/GlobalConfiguration.java`; `service/dto/GlobalConfigurationDTO.java`                                              | `Pendiente` |
