...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `@PreAuthorize` con `ROLE_COORDINATOR`              | Varios resources siguen aceptando un rol que los casos de uso ya no contemplan; debe quedar solo `ROLE_ADMIN` (u operativo donde aplique). `DocumentType` ya quedó restringido a `ROLE_ADMIN`. | `web/rest/ProgramResource.java:63`; `TrimesterResource.java:61`                                                              | `Pendiente` |
