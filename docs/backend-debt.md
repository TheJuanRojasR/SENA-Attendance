...
| --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `@PreAuthorize` con `ROLE_COORDINATOR`              | Resuelto para los catálogos (DocumentType, TimeSlot, Modality, JustificationType, Program y Trimester), ya restringidos a `ROLE_ADMIN`. Queda retirar `ROLE_COORDINATOR` de los resources operativos —Justification, ClassSchedule, ClassSection, ClassException, Attendance y Apprentice—, que se resuelve al implementar UC008–UC011. | `web/rest/TrimesterResource.java:61,83,112,181,195`; `web/rest/DocumentTypeResource.java:59-179`; `web/rest/TimeSlotResource.java:59-164`; `web/rest/ModalityResource.java:59-164`; `web/rest/JustificationTypeResource.java:57-175`; `web/rest/ProgramResource.java:62-235`; `web/rest/JustificationResource.java:64,96,139,215`; `web/rest/ClassScheduleResource.java:60,84,119,187`; `web/rest/ClassSectionResource.java:60,84,119,190,208`; `web/rest/ClassExceptionResource.java:60,84,119,187`; `web/rest/AttendanceResource.java:64,95,138,214`; `web/rest/ApprenticeResource.java:64,95,138,214` | `Pendiente` |
