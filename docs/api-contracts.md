...
| PUT    | `/api/modalities`        | `ROLE_ADMIN` o `ROLE_COORDINATOR` | Reemplaza; el `id` viaja en el cuerpo; `200`. |
| PATCH  | `/api/modalities`        | `ROLE_ADMIN` o `ROLE_COORDINATOR` | Actualización parcial; el `id` viaja en el cuerpo; `200`. |
